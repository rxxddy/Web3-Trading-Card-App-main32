...
export default function PacksShop() {
    const {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 lg:p-10 gap-4 justify-items-center">
                {/* {!loadingDirectListings ? (
                    ...
                    <div className="flex justify-center items-center h-[80vh]" role="status">
                        <svg aria-hidden="true" className="inline w-10 h-10 text-gray-200 animate-spin  fill-yellow-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="justify-start flex-wrap md:flex-col sm:flex-col">
                            <div>
